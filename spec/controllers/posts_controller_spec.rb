  ...
  context "member user doing CRUD on a post they don't own" do
    ...
    describe "POST create" do
      it "increases the number of Post by 1" do
        expect{ post :create, topic_id: my_topic.id, bookmark: {title: RandomData.random_sentence, body: RandomData.random_paragraph} }.to change(Post,:count).by(1)
      end

      it "assigns the new post to @post" do
        post :create, topic_id: my_topic.id, bookmark: {title: RandomData.random_sentence, body: RandomData.random_paragraph}
